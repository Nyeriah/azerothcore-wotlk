...
enum AcoreStrings
{
    ...
    // debug factionchange command (30100-30114)
    LANG_DEBUG_FACTIONCHANGE_HEADER               = 30100,
    LANG_DEBUG_FACTIONCHANGE_FLAG_FACTION          = 30101,
    LANG_DEBUG_FACTIONCHANGE_FLAG_RACE             = 30102,
    LANG_DEBUG_FACTIONCHANGE_FLAG_NONE             = 30103,
    LANG_DEBUG_FACTIONCHANGE_GUILD_FAIL            = 30104,
    LANG_DEBUG_FACTIONCHANGE_GUILD_OK              = 30105,
    LANG_DEBUG_FACTIONCHANGE_ARENA_CAPTAIN_FAIL    = 30106,
    LANG_DEBUG_FACTIONCHANGE_ARENA_CAPTAIN_OK      = 30107,
    LANG_DEBUG_FACTIONCHANGE_MAIL_FAIL             = 30108,
    LANG_DEBUG_FACTIONCHANGE_MAIL_OK               = 30109,
    LANG_DEBUG_FACTIONCHANGE_AUCTION_FAIL          = 30110,
    LANG_DEBUG_FACTIONCHANGE_AUCTION_OK            = 30111,
    LANG_DEBUG_FACTIONCHANGE_GOLD_FAIL             = 30112,
    LANG_DEBUG_FACTIONCHANGE_GOLD_OK               = 30113,
    LANG_DEBUG_FACTIONCHANGE_GOLD_NOLIMIT          = 30114,
    LANG_DEBUG_FACTIONCHANGE_NA                    = 30115
};
#endif
