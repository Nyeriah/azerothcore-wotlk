...
enum AcoreStrings
{
    ...
    // Respawn by spawn ID command
    LANG_RESPAWN_ID_NOT_FOUND           = 35441,
    LANG_RESPAWN_ID_MAP_NOT_LOADED      = 35442,
    LANG_RESPAWN_ID_CREATURE_ALIVE      = 35443,
    LANG_RESPAWN_ID_CREATURE_QUEUED     = 35444,
    LANG_RESPAWN_ID_GAMEOBJECT_ACTIVE   = 35445,
    LANG_RESPAWN_ID_GAMEOBJECT_QUEUED   = 35446,
